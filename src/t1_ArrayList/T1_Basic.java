...
public class T1_Basic {
	public static void main(String[] args) {
		...
		System.out.println("1.toString크기 : " + arrayList.toString());
		System.out.println("1.toString크기 : " + arrayList);
		System.out.println();
		...
		arrayList.remove(2);
		arrayList.remove("홍길동"); // 순차적(앞에서부터)으로 지움
		...
		//arrayList2.remove(200);  // 200번 인덱스가 없어서 오류 즉,200번째가 없다는뜻 ,() 안에는 객체 개념으로 써야함
		arrayList2.remove(new Integer(200)); // 실제 값을 삭제하려면 객체형식으로 삭체처리한다.
